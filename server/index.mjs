...
const TOOL_GROUPS = {
  ...
  runtime: ["launch_editor", "run_project", "get_debug_output", "stop_project", "simulate_input", "run_automation_test", "get_runtime_info", "get_runtime_scene_tree", "get_runtime_node_properties", "set_runtime_property", "call_runtime_method", "pause_runtime", "resume_runtime", "step_runtime", "send_runtime_input", "inject_runtime_pointer", "configure_runtime_observability", "poll_runtime_observability", "capture_runtime_screenshot", "query_runtime_physics", "get_runtime_audio_state", "set_runtime_audio_bus", "play_runtime_audio", "get_runtime_logs", "get_runtime_binding", "release_runtime_binding"],
...
const liveEditorGroups = new Set(["editor", "ui", "effects", "advanced_editor"]);
