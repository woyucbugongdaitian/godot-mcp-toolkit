...
try {
  ...
  for (const name of ["bind_editor", "get_editor_binding", "release_editor_binding", "create_2d_camera", "create_2d_light", "create_ui_component", "configure_stylized_rendering"]) assert.equal(toolNames.has(name), true, name);
