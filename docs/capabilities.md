...
- 2D cameras/lights, UI components, 3D primitives/cameras/lights/transforms/materials, animation tracks/keys, Navigation nodes, physics shapes, audio buses/players, themes, plugins, workspace, and resource reimport.
